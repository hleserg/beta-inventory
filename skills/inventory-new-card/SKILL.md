...
3. **Web**: look up the datasheet, pinout and a guide, and one clear photo of the board. For the photo, pass a *direct* image link: it ends in `.jpg`/`.png` and opens as a picture, not as a shop page.
